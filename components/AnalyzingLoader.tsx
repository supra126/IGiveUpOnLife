...
export function AnalyzingLoader() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center space-y-8 text-center animate-scale-in">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">{t("analyzing.description")}</p>
      </div>
    </div>
  );
}
